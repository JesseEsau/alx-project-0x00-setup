    ...
    return (
        <div>
            ...
            <div>
                ...
                <Button title="Small - rounded-lg" styles="bg-blue-600 px-3 py-1 text-sm rounded-full" />
                ...
                <Button title="Medium - rounded-lg" styles="bg-green-600 px-4 py-2 text-base rounded-full" />
                ...
                <Button title="Large - rounded-lg" styles="bg-red-600 px-6 py-3 text-lg rounded-full" />
